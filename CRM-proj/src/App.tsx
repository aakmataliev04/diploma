...
const AdminRoutes = () => (
  <Route element={<ProtectedRoute allowedRole="ADMIN" />}>
    <Route path="/admin" element={<Layout role="ADMIN" navigation={appNavigation.ADMIN} />}>
      ...
      <Route path="bouquets" element={<ModulePlaceholder title="Конструктор букетов" description="Редактирование шаблонов и рецептов букетов." />} />
...
const FloristRoutes = () => (
  <Route element={<ProtectedRoute allowedRole="FLORIST" />}>
    <Route path="/florist" element={<Layout role="FLORIST" navigation={appNavigation.FLORIST} />}>
      ...
      <Route path="bouquets" element={<ModulePlaceholder title="Конструктор букетов" description="Рабочие шаблоны и рецепты букетов для продажи." />} />
      <Route path="inventory" element={<Inventory />} />
    </Route>
  </Route>
);

          ...
          <div className="auth-switch">
            {roleOptions.map((role) => (
              <button
                key={role}
                type="button"
                className={role === selectedRole ? 'auth-switch-btn auth-switch-btn-active' : 'auth-switch-btn'}
